...
const RateLimited = () => {
  return (
    <div className="max-w-full w-[100%] mx-auto px-4 py-8 z-20">
        <div className="bg-gradient-to-tr from-blue-950 to-blue-800 border border-primary/30 rounded-lg shadow-md">
            <div className="flex flex-col mf:flex-row items-center p-6">
                ...
                <div className="flex-1 flex flex-col gap-2 items-center text-center md:text-left">
                    ...
                    <p className="text-sm text-gray-300">or Try again in few seconds...</p>
                </div>
            </div>
        </div>
    </div>
